...
african_countries<-c("Algeria","Angola","Benin","Botswana","Burundi",
...
china<- subset(china, country %in% african_countries)
wb<-wb %>%
...
data<-mutate(data,competition=(log_wbloan-log_cloan))
```
